...
const projData = [
  ...
  },
  {
    ...
    name: "OpinioMate",
    tech: "News API, EJS, Passport, Express-session, NodeJS, Express, MongoDB, Mongoose, MongoDB Atlas",
    description:
      "To Test: {email: test@test.com, password: test};  Less focus on UI, more focus on implementing different skills. Objective backend App that displays the use of User Authentication. It consumes News API rendering the latest news heading. The user creates an account for which Passport is being used, and is logged in to the main page where all users get to give their opinion in regards the shown news title. The session is being managed by express-session. Passwords are hashed and salted with passport. Templating happens with EJS and data persists with MongoDB via Atlas.",
    img1: PostMate,
    codeOne: PostCode1,
    codeTwo: PostCode2,
    codeThree: PostCode3,
